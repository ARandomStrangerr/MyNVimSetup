...
vim.api.nvim_set_keymap('i', '<S-CR>', 'v:lua.newLine()', {expr=true, noremap=true, silenttrue}); -- create new line with semicolone at the end of current line
...
vim.api.nvim_set_keymap('i', '"', 'v:lua.isNextChar(\'\"\') ? "<Right>" : \'""<Left>\'', {expr=true, noremap=true, silent=true}); -- auto complete open and close
